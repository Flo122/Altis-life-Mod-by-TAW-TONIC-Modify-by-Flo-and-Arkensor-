...
switch(true) do
{
	...
	{
		[[3,"News: Interpol hat eine internationale Drogenbande ausgehoben!"],"life_fnc_broadcast",true,false] call life_fnc_MP;
	...
	{
		[[3,"News: Öltanker gesunken!"],"life_fnc_broadcast",true,false] call life_fnc_MP;
	...
	{
		[[3,"News: China baut World-China-Center!"],"life_fnc_broadcast",true,false] call life_fnc_MP;
	...
	{
		[[3,"News: Anleger verlieren Vertrauen in Gold!"],"life_fnc_broadcast",true,false] call life_fnc_MP;
	...
	{
		[[3,"News: Elektronikindustrie benötigt Edelmetalle!"],"life_fnc_broadcast",true,false] call life_fnc_MP;
	...
	{
		[[3,"News: Anleger verlieren Vertrauen in Dollar!"],"life_fnc_broadcast",true,false] call life_fnc_MP;
	...
	{
		[[3,"News: Neue synthetische Droge überschwemmt Drogenmarkt!"],"life_fnc_broadcast",true,false] call life_fnc_MP;
	...
	{
		[[3,"News: China entdeckt Schildkröten als neue Medizin! Tierschützer sind besorgt!"],"life_fnc_broadcast",true,false] call life_fnc_MP;
