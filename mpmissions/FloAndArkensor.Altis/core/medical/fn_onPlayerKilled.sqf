...
{
[[format ["Killog >> Selbstmord: %1 hat sich umgebracht",_killer getVariable["realname",name _killer]]],"Arma3Log",false,false] call life_fnc_MP;
} else {
[[format ["Killog >>  Mord: %2 wurde von %1 mit einer %3 auf einer Distanz von %4 Meter getoetet",_killer getVariable["realname",name _killer], _unit getVariable["realname",name _unit], _killerWep, _distance]],"Arma3Log",false,false] call life_fnc_MP;
};
