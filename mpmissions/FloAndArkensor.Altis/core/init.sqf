...
//LIFE_ID_PlayerTags = ["LIFE_PlayerTags","onEachFrame","life_fnc_playerTags"] call BIS_fnc_addStackedEventHandler;//Playertags remove
...
_handle = [] spawn compile PreprocessFileLineNumbers "core\ALG\init.sqf";
diag_log "::ALG Client:: Initialization";
waitUntil {scriptDone _handle};
diag_log "::ALG Client:: initialized";
