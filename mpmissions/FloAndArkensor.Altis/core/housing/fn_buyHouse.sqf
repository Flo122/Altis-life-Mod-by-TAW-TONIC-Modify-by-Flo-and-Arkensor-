...
if(_action) then {
	if(life_atmcash_pirates < (_houseCfg select 0)) exitWith {hint format [localize "STR_House_NotEnough"]};
	...
	life_atmcash_pirates = life_atmcash_pirates - (_houseCfg select 0);
