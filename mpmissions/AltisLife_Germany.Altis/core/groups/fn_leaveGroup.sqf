...
{
	{
		if ((_x getVariable ["gangName","omgRanD0M"]) == _name && !isNull(_x getVariable ["gangGroup",objNull])) exitWith { [player] joinSilent (group _x); };
	} foreach playableUnits;
	hint "Returned to gang group chat.";
}
else
{
