...
if(_building getVariable["Secured",false]) then {
	...
	[[_house,name player,8],"TON_fnc_clientMessage",_uid,false] spawn life_fnc_MP;
...
[[getPlayerUID player,profileName,"55"],"life_fnc_wantedAdd",false,false] spawn life_fnc_MP;