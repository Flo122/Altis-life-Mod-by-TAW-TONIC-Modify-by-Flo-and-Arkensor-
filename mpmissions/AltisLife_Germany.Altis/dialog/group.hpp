class life_my_group_Diag {
	...
	class controls {
		...
		class GroupLock : Life_RscButtonMenu 
		{
			idc = 2622;
			text = "Lock";
			colorBackground[] = {0.5, 0, 0, 0.5};
			onButtonClick = "[] call life_fnc_lockGroup";
			x = 0.50;
			y = 0.31;
			w = (6.25 / 40);
			h = (1 / 25);
		...
		class GroupUnlock : Life_RscButtonMenu 
		{
			idc = 2623;
			text = "Unlock";
			colorBackground[] = {0.5, 0, 0, 0.5};
			onButtonClick = "[] call life_fnc_unlockGroup";
			x = 0.50;
			y = 0.31;
			w = (6.25 / 40);
			h = (1 / 25);
...
class Life_Browse_Group_Diag {
	...
	class controls {
		...
		class GroupJoin : Life_RscButtonMenu {
			...
			text = "Join";
			colorBackground[] = {0.5, 0, 0, 0.5};
			onButtonClick = "[] call life_fnc_joinGroup";
			x = 0.32;
			y = 0.65;
			w = (6.25 / 40);
			h = (1 / 25);
...
class Life_Create_Group_Diag {
	...
	class controls {
		...
		class InfoMsg : Life_RscStructuredText
		{
			idc = -1;
			sizeEx = 0.020;
			text = "<t align='center'>Eine Gruppe zu erstellen kostet nichts.</t>";
			x = 0.1;
			y = 0.25;
			w = 0.5; h = (1 / 24);
		};
...
class Life_Group_Prompt
{
	...
	class controls 
	{
		class InfoMsg : Life_RscStructuredText
		{
			idc = -1;
			sizeEx = 0.020;
			text = "<t align='center'><t size='.8px'>Du bist derzeit nicht ein einer Gruppe. Was möchtest du tun ?</t></t>";
			x = 0.287;
			y = 0.2 + (11 / 250);
			w = 0.5; h = 0.12;
		};
