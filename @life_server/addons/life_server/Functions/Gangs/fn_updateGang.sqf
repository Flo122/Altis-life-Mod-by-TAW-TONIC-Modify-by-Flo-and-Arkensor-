...
switch (_mode) do {
	case 0: {
		...
		_maxMembers = _group getVariable ["gang_maxMembers",20];
	...
	case 2: {
		_query = format["UPDATE gangs SET maxmembers='%1' WHERE id='%2'",(_group getVariable ["gang_maxMembers",4]),_groupID];
	};
